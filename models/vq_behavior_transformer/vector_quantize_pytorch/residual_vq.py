# Based on DynaMo (models/vq_behavior_transformer/vector_quantize_pytorch/residual_vq.py): https://github.com/jeffacce/dynamo_ssl/blob/main/models/vq_behavior_transformer/vector_quantize_pytorch/residual_vq.py
