# LIBERO simulation environment: https://github.com/Lifelong-Robot-Learning/LIBERO
import os
import yaml
...
def get_default_path_dict(custom_location=None):
    ...
    dataset_default_path = os.path.join(benchmark_root_path, "../../datasets") # changed from
...
def get_libero_path(query_key):
    ...
    # for key in config: ### changed from active
